...
export const Vision = () => (
  <section id="platform" data-testid="platform-section" className="relative py-24 sm:py-36 border-t border-white/[0.06]">
    <div className="mx-auto max-w-7xl px-5 sm:px-8">
      ...
      <Reveal delay={0.15}>
        <div className="mt-16 grid md:grid-cols-2 gap-3" data-testid="platform-comparison">
