...
NOTIFICATION_KIND_BILLING = "billing"
NOTIFICATION_KINDS = {
...
# --- Commerce / Billing / Payments (Phase 17) -----------------------------------
# Plan / entitlement catalog codes. Seeded catalog contains the FREE plan;
# paid plans are configuration-driven catalog rows (never invented prices).
PLAN_CODE_FREE = "free"
PLAN_CODES_SEEDED = {PLAN_CODE_FREE}

# Subscription lifecycle — explicit transitions, org-owned.
...
SUBSCRIPTION_TRANSITIONS = {
    ...
    SUBSCRIPTION_STATUS_CANCELLED: set(),
    SUBSCRIPTION_STATUS_EXPIRED: set(),
}
...
# Entitlement feature codes (numeric limit_value = null means unlimited).
ENTITLEMENT_JOBS_CREATE = "jobs.create"
ENTITLEMENT_JOBS_ACTIVE = "jobs.active"
ENTITLEMENT_CANDIDATE_SEARCH = "candidate.search"
ENTITLEMENT_CANDIDATE_OUTREACH = "candidate.outreach"
ENTITLEMENT_AI_ATHENA = "ai.athena"
ENTITLEMENT_AI_INTERVIEW = "ai.interview"
ENTITLEMENT_ANALYTICS = "analytics"
ENTITLEMENT_PREMIUM_SUPPORT = "premium_support"
ENTITLEMENT_CODES = {
    ENTITLEMENT_JOBS_CREATE,
    ENTITLEMENT_JOBS_ACTIVE,
    ENTITLEMENT_CANDIDATE_SEARCH,
    ENTITLEMENT_CANDIDATE_OUTREACH,
    ENTITLEMENT_AI_ATHENA,
    ENTITLEMENT_AI_INTERVIEW,
    ENTITLEMENT_ANALYTICS,
    ENTITLEMENT_PREMIUM_SUPPORT,
}
...
REFUND_STATUSES = {REFUND_STATUS_PENDING, REFUND_STATUS_SUCCEEDED, REFUND_STATUS_FAILED}
...
# Webhook event handling (signature/replay/duplicate safe).
...
WEBHOOK_EVENT_STATUS_DUPLICATE = "duplicate"
...
# Audit actions.
AUDIT_ACTION_SUBSCRIPTION_CREATED = "billing.subscription.created"
AUDIT_ACTION_SUBSCRIPTION_CHANGED = "billing.subscription.changed"
AUDIT_ACTION_SUBSCRIPTION_CANCELLED = "billing.subscription.cancelled"
AUDIT_ACTION_SUBSCRIPTION_PAUSED = "billing.subscription.paused"
AUDIT_ACTION_SUBSCRIPTION_EXPIRED = "billing.subscription.expired"
AUDIT_ACTION_PAYMENT_CREATED = "billing.payment.created"
AUDIT_ACTION_PAYMENT_SUCCEEDED = "billing.payment.succeeded"
AUDIT_ACTION_PAYMENT_FAILED = "billing.payment.failed"
AUDIT_ACTION_REFUND_CREATED = "billing.refund.created"
AUDIT_ACTION_REFUND_SUCCEEDED = "billing.refund.succeeded"
AUDIT_ACTION_INVOICE_ISSUED = "billing.invoice.issued"
AUDIT_ACTION_INVOICE_PAID = "billing.invoice.paid"
AUDIT_ACTION_WEBHOOK_RECEIVED = "billing.webhook.received"
AUDIT_ACTION_WEBHOOK_VERIFIED = "billing.webhook.verified"
AUDIT_ACTION_WEBHOOK_REJECTED = "billing.webhook.rejected"
AUDIT_ACTION_USAGE_RECORDED = "billing.usage.recorded"
AUDIT_ACTION_FINANCE_REFUND_AUTHORIZED = "finance.refund.authorized"
